...
let s:C2 = [ s:gui_cyan, s:gui_gray1,  s:cterm_cyan, s:cterm_gray1 ]
...
let s:I2 = [ s:gui_yellow, s:gui_gray1,  s:cterm_yellow, s:cterm_gray1 ]
...
let s:V2 = [ s:gui_blue, s:gui_gray1,  s:cterm_blue, s:cterm_gray1 ]
...
let s:R2 = [ s:gui_red, s:gui_gray1,  s:cterm_red, s:cterm_gray1 ]
...
" Inactive
let s:IA1 = [ s:gui_black, s:gui_gray6, s:cterm_black, s:cterm_bright_black ]
let s:IA2 = [ s:gui_green, s:gui_gray1,  s:cterm_bright_black , s:cterm_gray1 ]
let s:IA3 = [ s:gui_green, s:gui_gray6, s:cterm_bright_black, s:cterm_black ]
let g:airline#themes#srcery#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

" Warnings
let s:W = [ s:gui_black, s:gui_orange, s:cterm_black, s:cterm_orange ]
let g:airline#themes#srcery#palette.normal.airline_warning = [
     \ s:W[0], s:W[1], s:W[2], s:W[3]
     \ ]

let g:airline#themes#srcery#palette.commandline.airline_warning =
    \ g:airline#themes#srcery#palette.normal.airline_warning

let g:airline#themes#srcery#palette.insert.airline_warning =
    \ g:airline#themes#srcery#palette.normal.airline_warning

let g:airline#themes#srcery#palette.visual.airline_warning =
    \ g:airline#themes#srcery#palette.normal.airline_warning

let g:airline#themes#srcery#palette.replace.airline_warning =
    \ g:airline#themes#srcery#palette.normal.airline_warning

" Errors
let s:E = [ s:gui_black, s:gui_red, s:cterm_black, s:cterm_red ]
let g:airline#themes#srcery#palette.normal.airline_error = [
     \ s:E[0], s:E[1], s:E[2], s:E[3]
     \ ]

let g:airline#themes#srcery#palette.commandline.airline_error =
    \ g:airline#themes#srcery#palette.normal.airline_error

let g:airline#themes#srcery#palette.insert.airline_error =
    \ g:airline#themes#srcery#palette.normal.airline_error

let g:airline#themes#srcery#palette.visual.airline_error =
    \ g:airline#themes#srcery#palette.normal.airline_error

let g:airline#themes#srcery#palette.replace.airline_error =
    \ g:airline#themes#srcery#palette.normal.airline_error
